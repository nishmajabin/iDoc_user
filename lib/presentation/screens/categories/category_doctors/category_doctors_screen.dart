...
//   }
// }
// lib/presentation/screens/categories/category_doctors/category_doctors_screen.dart
import 'package:flutter/material.dart';
import 'package:flutter_bloc/flutter_bloc.dart';
    ...
    return AppScaffold(
      ...
      body: Column(
        children: [
          DoctorsSearchBar(
            hintText: 'Search doctors...',
            onSearch: (value) => context.read<DoctorBloc>().add(
              SearchDoctorsEvent(value),
            ),
            onClear: () => context.read<DoctorBloc>().add(ResetSearchEvent()),
          ),
          const Expanded(child: CategoryDoctorsList()),
